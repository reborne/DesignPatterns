...
public class AbstractFactoryPatternDemo {
	 ...
	 * one of the best ways to create an object. In Abstract Factory pattern, an
	 * interface is responsible for creating a factory of related objects
	 * without explicitly specifying their classes. Each generated factory can
